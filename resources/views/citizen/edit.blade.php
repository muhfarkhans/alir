                                        ...
                                        <div class="col-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="number" class="form-control form-control-lg" name="nik"
                                                    placeholder="Masukkan nomor induk kependudukan" value="{{$citizen->nik}}" required>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="text" class="form-control form-control-lg" name="fullname"
                                                    placeholder="Masukkan nama lengkap" value="{{$citizen->fullname}}" required>
                                            </div> 
                                        </div>                                    
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                placeholder="Masukkan nomor telpon" value="{{$citizen->phone}}" required>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                placeholder="Masukkan jabatan" value="{{$citizen->role}}" required>
                                            </div>
                                        </div>
                                        <div class="mb-3 form-group">
                                            <label>Alamat</label>
