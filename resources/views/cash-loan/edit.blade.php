                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            @endif
                            <form id="main-form" class="form form-horizontal"
                                action="{{ route('cash-loan.update', $loan->id) }}" method="post">
                                @csrf
                                <div class="form-body">
                                    ...
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" class="form-control" name="code_dpm"
                                            value="{{ $loan->code_dpm }}" required>
                                    </div>
                                    <div class="mb-3 form-group">
                                        <label for="">Alamat</label>
                                        <textarea name="address" id="" cols="30" rows="3" class="form-control" required>{{ $loan->address }}</textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="date" class="form-control" name="disbursement_date"
                                                    value="{{ $loan->disbursement_date }}" disabled required>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="date" class="form-control" name="due_date"
                                                    value="{{ $loan->due_date }}" disabled required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="mb-3 form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="numeric" class="form-control" name="total_loan"
                                                        ...
                                                        aria-describedby="basic-addon1" value="{{ $loan->total_loan }}"
                                                        disabled required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="mb-3 form-group">
                                                ...
                                                <select class="form-select" aria-label="Default select example"
                                                    name="loan_period" disabled required>
                                                    <option value="12" @selected($loan->loan_period == 12)>12 bulan</option>
                                                    <option value="24" @selected($loan->loan_period == 24)>24 bulan</option>
                                                    <option value="36" @selected($loan->loan_period == 36)>36 bulan</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="number" class="form-control" name="contribution_percentage"
                                                    placeholder="Masukkan persentase kontribusi"
                                                    value="{{ $loan->contribution_percentage }}" disabled required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-3">
...
@push('js')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            let initialDataItem = JSON.parse(@json($jsonMembers))
            initialDataItem.forEach(v => {
                addRowData([
                    v.name,
                    v.nik,
                    v.position,
