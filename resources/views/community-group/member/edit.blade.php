            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Update anggota kelompok masyarakat</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-horizontal"
                                action="{{ route('community-group.member.update', ['community_id' => $member->community_group_id, 'id' => $member->id]) }}"
                                method="post">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                    ...
                                    <div class="mb-3 form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="role"
                                            placeholder="Masukkan jabatan" value="{{ $member->role }}" required>
                                    </div>
                ...
                const choicesTwo = new Choices(mySelecttwo, {
                    choices: data.map((item) => {
                        if (item.is_guarantor == 1) {
                            ...
                            if (item.id == {{ $member->gurantor_citizen_id }}) {
                                isSelected = true
                            }
